...
public enum ErrorCode {
    ...
    USER_USERNAME_INVALID(1002,"Username must be at least 3 character ",HttpStatus.BAD_REQUEST),
    USER_PASSWORD_INVALID(1003,"Password must be at least 8 character ",HttpStatus.BAD_REQUEST),
